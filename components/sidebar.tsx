...
import { Box, Calendar, ClipboardList, Package, Settings, Trash2, Upload, User, Rocket, Layers } from "lucide-react"
...
export default function Sidebar() {
  ...
  const navItems = [
    { name: "Commander Dashboard", href: "/", icon: Rocket },
    { name: "Astronaut Dashboard", href: "/astronaut", icon: User },
    ...
    >
      ...
      <div className="mt-auto border-t border-border/40 p-2">
        ...
        >
          ...
          {!collapsed && <span>Commander Smith</span>}
        </div>
      </div>
    </div>
  )
